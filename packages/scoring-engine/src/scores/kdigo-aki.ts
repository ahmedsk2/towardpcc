...
export const kdigoAki = defineScore({
  ...
  tagline: defineText(
    "kdigo.tagline",
    "Acute kidney injury stage from creatinine and urine output",
  ),
  version: "1.2.1",
  status: "published",
