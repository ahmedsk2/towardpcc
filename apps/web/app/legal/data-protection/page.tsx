...
export default function DataProtectionPage() {
  return (
    <div className="mx-auto max-w-[760px] px-6 py-16 md:py-24">
      ...
      <p className="mt-5 max-w-[62ch] text-lg leading-relaxed text-ink-body">{dp.lede}</p>
      ...
      <section className="mt-12">
        <h2 className="font-display text-xl font-medium text-ink-strong">{dp.security.heading}</h2>
