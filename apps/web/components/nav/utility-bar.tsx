    ...
    <div className="bg-surface-hero-raised text-ink-on-dark/80" data-print="hide">
      <div className="mx-auto flex max-w-[1280px] flex-wrap items-center gap-x-6 gap-y-1 px-6 py-2 text-[13px]">
        <a
          ...
          className="inline-flex items-center gap-2 rounded-sm transition-colors duration-150 hover:text-coral focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-coral"
        >
        ...
        <a
          ...
          className="ms-auto grid size-7 place-items-center rounded-full bg-white/10 transition-colors duration-150 hover:bg-accent focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-coral"
        >
